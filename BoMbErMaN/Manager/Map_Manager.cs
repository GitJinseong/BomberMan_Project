...
namespace BoMbErMaN.Manager
{
    public class Map_Manager
    {
        ...
        {
            Tile = new Tile_Manager(MapSize_X, MapSize_Y, 28, 8, Player, Monster);
            ...
            Tile.ItemBlock.Set_Dir_X(8, 16, 24, 32, 8, 16, 24, 32);
            Tile.ItemBlock.Set_Dir_Y(4, 4, 4, 4, 12, 12, 12, 12);
            MapName = "Stage <1>";
        }

        public void Set_CreateMap002()
        {
            Tile = new Tile_Manager(MapSize_X, MapSize_Y, 37, 12, Player, Monster);
            ...
            Tile.ItemBlock.Set_Dir_X(0, 8, 16, 24, 32, 40, 0, 8, 16, 24, 32, 40);
            Tile.ItemBlock.Set_Dir_Y(0, 0, 0, 0, 0, 0, 15, 15, 15, 15, 15, 15);
            MapName = "Stage <2>";
        }

        public void Set_CreateMap003()
        {
            Tile = new Tile_Manager(MapSize_X, MapSize_Y, 90, 16, Player, Monster);
            ...
            Tile.ItemBlock.Set_Dir_X(1, 2, 17, 18, 21, 22, 38, 39, 1, 2, 17, 18, 21, 22, 38, 39);
            Tile.ItemBlock.Set_Dir_Y(1, 1, 1, 1, 1, 1, 1, 1, 14, 14, 14, 14, 14, 14, 14, 14);
            MapName = "Stage <3>";
        }
    }
}
